...
export default function Footer() {
  return (
    <div>
      <div className="container pt-4" style={{ backgroundColor: "lightgreen", height: "348px", maxWidth: "inherit"}}>
        <footer className="">
          <div className="row">
            <div className="col-6 col-md-2 mb-3">
              ...
              <ul className="nav flex-column">
                ...
                <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-body-secondary">Subscribe</a></li>
            ...
            <div className="col-6 col-md-2 mb-3">
              <h5>Explore</h5>
              <ul className="nav flex-column">
                <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-body-secondary">Job Opportunities</a></li>
