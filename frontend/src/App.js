...
import TransportationDetails from "./components/client/TransportationDetails";
import UpdateTransportationForm from "./components/client/UpdateTransportationForm";
      ...
      <div className="App">
        <Routes>
          ...
          <Route
            ...
            element={<PlacesToVisitManagement />}
          />
          <Route
          ...
          <Route
            path="/hotel-villa-management"
            element={<HotelVillaManagement />}
          />
          <Route
          ...
          />
          <Route
            path="/update/transportation/:id"
            element={<UpdateTransportationForm />}
          />
        </Routes>
      </div>
    </Router>
